...
# Legacy JSON / execution-report bucket names (agentic_features.json keys).
STORAGE_BUCKETS: tuple[str, ...] = ("RAN", "Edge", "Core")
STORAGE_TO_DOMAIN: dict[str, str] = {
    "RAN": ACCESS_ISP,
    "Edge": PERIMETER_IDS,
    "Core": ENDPOINT_EDR,
}
DOMAIN_TO_STORAGE: dict[str, str] = {v: k for k, v in STORAGE_TO_DOMAIN.items()}
