"""Standalone RAG Part 1: build FAISS vector store (no .ipynb). Run from repo root via scripts/rag_build.py."""
...
from scripts.rag_io import faiss_from_documents_batched, save_vector_store
