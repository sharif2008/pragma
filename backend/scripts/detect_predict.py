"""Standalone VFL SHAP prediction (merged from 02_detect_shap.ipynb)."""
...
from scripts.vfl_models import VFLModel, AgentMetaModel
...
if not agent_names:
    # Use fixed agent names from scripts.vfl as fallback
...
# Model classes are now imported from vfl_models.py
