...
Used by 03_rag_index.ipynb and 04_action_plan.ipynb.
"""
...
# Defaults align with 03_rag_index.ipynb (smaller chunks for retrieval precision)
...
def load_parent_store(vector_store_dir: Path) -> Dict[str, Any]:
    ...
    from scripts.rag_index import load_parent_store as _load
